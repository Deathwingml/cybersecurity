...
from cybersecurity.utils import load_object, save_object
from cybersecurity.config import TARGET_COLUMN
from cybersecurity.predictor import ModelResolver
from cybersecurity.entity.config_entity import ModelPusherConfig
from cybersecurity.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ModelPusherArtifact
...
class ModelPusher:
    ...
    def initiate_model_pusher(self,)->ModelPusherArtifact:
        try:
            #load object
            logging.info(f"Loading transformer, model, and target_encoder")
